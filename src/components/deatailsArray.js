const detailsArray = [
  {
    ...
    paragraphs: [
      ...
      "Some of the tech-stack I worked with are Vuejs, Laravel, Bootstrap, AWS and MySQL. I also gave consultation on engineering and product-wise best practices (and of course, completely free of charge) ",
    ],
  },
  {
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "well this app helps you to draw a graph(or graphs) for any equation I.e be it simple, quadratic, cubic and so forth, with other extra features.",
      "Tech stack is plain javascript, CSS and HTML.",
    ],
  },
  {
    ...
    paragraphs: [
      ...
      "If you are also an anime fan, you can check it out and see how cool it is.",
    ],
  },
];
